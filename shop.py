...
print('12月份销售总金额:'+str(253.6*10+86.3*60+96.8*43+135.9*63+65.8*63+49.3*120+86.3*72+253.6*69+86.3*35+
253.6*140+86.3*90+135.9*24+65.8*45+96.8*25+86.3*60+65.8*129+253.6*10+96.8*43+65.8*63+86.3*60+135.9*63+96.8*60+
65.8*58+86.3*140+65.8*48+96.8*43+135.9*57+253.6*10+65.8*63+96.8*78))
# 198400.6
yrf = str(253.6*(10+69+140+10+10)/198400.6)
yrf=float(yrf[:6])
nzk = str(86.3*(60+72+35+90+60+60+140)/198400.6)
nzk=float(nzk[:6])
fy=str(96.8*(43+25+43+60+43+78)/198400.6)
fy=float(fy[:6])
pc=str(135.9*(63+24+63+57)/198400.6)
pc=float(pc[:6])
tx=str(65.8*(63+45+63+58+48+63)/198400.6)
tx=float(tx[:6])
cs=str(49.3*120/198400.6)
cs=float(cs[:6])
print('羽绒服销售占比:'+str(yrf*100)+'%')
print('牛仔裤销售占比:'+str(nzk*100)+'%')
print('风衣销售占比:'+str(fy*100)+'%')
print('皮草销售占比:'+str(pc*100)+'%')
print('T恤销售占比:'+str(tx*100)+'%')
print('衬衫销售占比:'+str(cs*100)+'%')
